// Adapted from @wonderwhy-er/desktop-commander 0.2.51.
// MIT license: DESKTOP_COMMANDER_LICENSE.txt in this directory.
/**
...
${JSON.stringify(data)}`;
        ...
        if (mode === 'append') {
            try {
                ...
                if (Array.isArray(parsedContent)) {
                    ...
                    const startRow = (worksheet.rowCount || 0) + 1;
    ...
    worksheetToArray(workbook, sheetRef, range, offset, length) {
        ...
        if ((endRow-startRow+1)*(endCol-startCol+1)>200000)throw new Error('Read exceeds 200000 cells; specify a smaller range or length');
                ...
                if (cell.value !== null && cell.value !== undefined) {
                    if (typeof cell.value === 'object') {
                        ...
                        if ('formula' in cell.value) {
                            value = {formula: cell.value.formula, result: cell.value.result ?? null};
                        }
    ...
    parseCellRange(range) {
        ...
        if (match[3] && match[4]) {
            ...
            if(startRow<1||endRow<startRow||endCol<startCol||endRow>1048576||endCol>16384)throw new Error('Invalid worksheet range bounds');
            return { startRow, startCol, endRow, endCol };
        }
        if(startRow<1||startRow>1048576||startCol>16384)throw new Error('Invalid worksheet cell bounds');
